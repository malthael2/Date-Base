...
Consulta& Consulta::operator=(const Consulta& q){
    this->_tipo_consulta=q._tipo_consulta;
    this->_nombre_tabla=q._nombre_tabla;
    this->_campo1=q._campo1;
    this->_campo2=q._campo2;
    this->_valor=q._valor;
    this->_conj_campos=q._conj_campos;
    this-> _subconsulta1=q. _subconsulta1;
    this-> _subconsulta2 = q. _subconsulta2;
    return *this;
}

bool Consulta::operator==(const Consulta& otra) const{
    if(
            this->_tipo_consulta == otra._tipo_consulta and
            this->_nombre_tabla == otra._nombre_tabla and
            this->_campo1 == otra._campo1 and
            this->_campo2 == otra._campo2 and
            this->_valor == otra._valor and
            this->_conj_campos == otra._conj_campos and
            this->_subconsulta1 == otra._subconsulta1 and
            this->_subconsulta2 == otra._subconsulta2
            ) return true;
    else return false;
}
